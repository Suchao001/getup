      ...
      <>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">
                {userProfile?.birthdate
                  ? dayjs(userProfile.birthdate).format("MMMM D, YYYY")
                  : "Not set"}
              </Typography>
            </Grid>
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">
                {userProfile?.estimated_death_date
                  ? dayjs(userProfile.estimated_death_date).format(
                      "MMMM D, YYYY"
                    )
                  : "Not set"}
              </Typography>
        ...
        >
          ...
          <LifeCalculator
            ...
            initialExpectedAge={
              userProfile?.estimated_death_date
                ? dayjs(userProfile.estimated_death_date).diff(
                ...
                >
                  <Avatar
                    sx={{
                      ...
                      backgroundColor:
                        page === "profile" ? "primary.main" : undefined,
                      cursor: "pointer",
                    }}
                  ...
                  <Avatar
                    sx={{
                      ...
                      "&:hover": { backgroundColor: "primary.main" },
                      backgroundColor:
                        page === "activity" ? "primary.main" : undefined,
                      cursor: "pointer",
                    }}
                  ...
                  <Avatar
                    sx={{
                      ...
                      "&:hover": { backgroundColor: "primary.main" },
                      backgroundColor:
                        page === "manage" ? "primary.main" : undefined,
                      cursor: "pointer",
                    }}
