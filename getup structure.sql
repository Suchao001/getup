...
--
-- Host: localhost:3306
-- Generation Time: Sep 25, 2024 at 07:09 PM
...
--
ALTER TABLE `habit_history`
  ADD CONSTRAINT `habit_history_ibfk_1` FOREIGN KEY (`habit_id`) REFERENCES `habits` (`id`);

--
-- Constraints for table `habit_recommendation`
--
ALTER TABLE `habit_recommendation`
  ADD CONSTRAINT `habit_recommendation_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `habit_category` (`id`);
